...
public abstract class BaseControllerCover extends BaseCover implements View.OnClickListener, OnTimerUpdateListener, SeekBar.OnSeekBarChangeListener {
     ...
     *
     * @param enabled          手势
     * @param slideEnabled     滑动
     * @param longPressEnabled 长按
     */
    protected void setGestureEnabled(boolean enabled, boolean slideEnabled, boolean longPressEnabled) {
        // 手势
        Bundle bundle = BundlePool.obtain();
        bundle.putBoolean(EventKey.BOOL_ARG1, enabled);
        bundle.putBoolean(EventKey.BOOL_ARG2, slideEnabled);
        bundle.putBoolean(EventKey.BOOL_ARG3, longPressEnabled);
