...
import com.kaisengao.ksgframe.common.util.VibratorUtil;
import com.kaisengao.ksgframe.R;
import com.kaisengao.ksgframe.common.widget.GestureTipsView;
...
public class GestureCover extends BaseCover implements View.OnTouchListener, OnTouchGestureListener, View.OnLayoutChangeListener {
    ...
    public void initViews() {
        ...
        this.mGestureTouchHelper.setGestureLongPressEnabled(false);
        //  Views
    ...
    public void onPrivateEvent(int eventCode, Bundle bundle) {
        if (eventCode == CoverConstant.PrivateEvent.CODE_GESTURE_ENABLED) {
            ...
            // 长按 开启/关闭
            this.mGestureTouchHelper.setGestureLongPressEnabled(bundle.getBoolean(EventKey.BOOL_ARG3, false));
        }
    }
