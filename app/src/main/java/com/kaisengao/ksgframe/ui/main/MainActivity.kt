package com.kaisengao.ksgframe.ui.main
...
import com.kaisengao.ksgframe.ui.main.adapter.MainAdapter
import com.kaisengao.ksgframe.ui.main.fragment.PPXFragment
import com.kaisengao.ksgframe.ui.main.fragment.XBBFragment
...
class MainActivity : BaseVmActivity<ActivityMainBinding, MainViewModel>() {
    ...
    override fun onOptionsItemSelected(item: android.view.MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.slack_off -> {
                // 摸鱼
                this.startActivity(Intent(this, FishActivity::class.java))
            }
        }
        return true
    }
