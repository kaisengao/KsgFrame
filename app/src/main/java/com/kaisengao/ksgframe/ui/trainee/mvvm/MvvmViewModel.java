package com.kaisengao.ksgframe.ui.trainee.mvvm;
...
import com.kaisengao.ksgframe.common.load.MVVMVideoLoad;
...
public class MvvmViewModel extends ToolbarViewModel {
    ...
    public void requestVideos() {
        this.mModel
                .requestVideos()
                .doOnSubscribe(this)
                .subscribe(new BaseLoadPageObserver<List<VideoBean>>(getLoadState()) {
                    @Override
