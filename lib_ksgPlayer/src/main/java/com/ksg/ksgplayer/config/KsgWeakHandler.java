...
/**
 * @author kaisengao
 * @create: 2019/1/7 15:25
 * @describe: 弱引用handler
 */
@SuppressWarnings("unused")
public class KsgWeakHandler {
    /**
     ...
     */
    public KsgWeakHandler(@Nullable Handler.Callback callback) {
     ...
     */
    public KsgWeakHandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public KsgWeakHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
